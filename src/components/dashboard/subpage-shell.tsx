...
export const SubpageShell = ({ children, onBack, title }: SubpageShellProps) => (
  <div className="fixed inset-0 z-50 flex flex-col bg-background/95 p-2 sm:p-4">
    <div className="animate-subpage-in motion-reduce:animate-none flex min-h-0 flex-1 flex-col overflow-hidden border border-border/60 bg-background">
